...
# MOM6 supergrid:
nc_sgrd = netCDF4.Dataset('../supergrid/ocean_hgrid.nc')
...
# Topography and mask
nc_topo = netCDF4.Dataset('../topography/topo.sub150.tx2_0v1.SRTM15_V2.4.edit2.SmL1.0_C1.0.nc')
...
filename = 'tx2_0v1_grid.nc'
nc = netCDF4.Dataset(filename, 'w', format='NETCDF3_64BIT')
nc.Description = 'CESM MOM6 2.0 degree grid'
nc.Author = 'Frank, Fred, Gustavo, William (chengz@ucar.edu)'
nc.Created = datetime.now().isoformat()
nc.type = 'Glogal 2.0 degree grid file'
