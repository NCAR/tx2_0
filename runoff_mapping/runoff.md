...
In this section, we will generage mapping files used to spread liquid and frozen water into the ocean.
[CIME](https://github.com/ESMCI/cime) provides tools to help generate these maps.
Please build the `runoff_map` executable by following the instructions provided 
[here](https://github.com/ESMCI/cime/blob/master/tools/mapping/gen_mapping_files/runoff_to_ocn/INSTALL)
before proceeding to the next steps.

## JRA-55 (used in C- and G-compsets)

Example of a namelist used to generate mapping files from `JRA-55` to `tx2_0` (file `map_JRA_to_tx2_0.nml`):
```
&input_nml
   gridtype     = 'obs'
   file_roff    = '/glade/campaign/cesm/cesmdata/inputdata/lnd/dlnd7/JRA55/domain.roff.JRA025m.190213.nc',
   file_ocn     = '/glade/work/chengz/cesm.configs/tx2_0/mesh/tx2_0v1_260526_SCRIP.nc'
   file_nn      = 'map_JRA025m_to_tx2_0v1_nn.260527.nc'
   file_smooth  = 'map_JRA025m_to_tx2_0v1_sm_e100r100_260527.nc'
   file_new     = 'map_JRA025m_to_tx2_0v1_nnsm_e100r100_260527.nc'
   title        = 'runoff map: JRA-55 -> tx2_0v1, nearest neighbor and smoothed'
   eFold        = 100000.0
   rMax         = 100000.0
   step1 = .true.
   step2 = .true.
...
/glade/work/chengz/cesm.sandboxes/cesm3_0_alpha08b/cime/tools/mapping/gen_mapping_files/runoff_to_ocn/runoff_map < map_JRA_to_tx2_0.nml
```
Run the following:
```
./JRA_to_ocn.sh
...
Example of a namelist used to generate mapping files from `r05` to `tx2_0` (file `map_r05_to_tx2_0.nml`):
```
&input_nml
   gridtype     = 'rtm'
   file_roff    = '/glade/campaign/cesm/cesmdata/inputdata/lnd/clm2/rtmdata/rdirc.05.061026'
   file_ocn     = '/glade/work/chengz/cesm.configs/tx2_0/mesh/tx2_0v1_260526_SCRIP.nc'
   file_nn      = 'map_r05_to_tx2_0_nn.260527.nc'
   file_smooth  = 'map_r05_to_tx2_0_sm_e100r100_260527.nc'
   file_new     = 'map_r05_to_tx2_0_nnsm_e100r100_260527.nc'
   title        = 'runoff map: r05 -> tx2_0v1, nearest neighbor and smoothed'
   eFold        = 100000.0
   rMax         = 100000.0
   step1 = .true.
   step2 = .true.
...
source /glade/work/chengz/cesm.sandboxes/cesm3_0_alpha08b/cime/tools/mapping/gen_mapping_files/runoff_to_ocn/src/.env_mach_specific.sh
export TMPDIR=/glade/derecho/scratch/chengz/
/glade/work/chengz/cesm.sandboxes/cesm3_0_alpha08b/cime/tools/mapping/gen_mapping_files/runoff_to_ocn/runoff_map < map_r05_to_tx2_0.nml
```
Run the following:
```
./r05_to_ocn.sh
...
Example of a namelist used to generate mapping files from `gland4km` to `tx2_0` (file `map_greenland_4km_to_tx2_0.nml`):
```
&input_nml
   gridtype     = 'scrip'
   file_roff    = '/glade/campaign/cesm/cesmdata/inputdata/glc/cism/griddata/SCRIPgrid_greenland_4km_epsg3413_c170414.nc'
   file_ocn     = '/glade/work/chengz/cesm.configs/tx2_0/mesh/tx2_0v1_260526_SCRIP.nc'
   file_nn      = 'map_gland4km_to_tx2_0v1_nn.260527.nc'
   file_smooth  = 'map_gland4km_to_tx2_0v1_sm_e100r100_260527.nc'
   file_new     = 'map_gland4km_to_tx2_0v1_nnsm_e100r100_260527.nc'
   title        = 'runoff map: gland4km -> tx2_0v1, nearest neighbor and smoothed'
   eFold        = 100000.0
   rMax         = 100000.0
   step1 = .true.
   step2 = .true.
